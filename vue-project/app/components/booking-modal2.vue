	...
	await withLoading(async () => {
		try {
			bookingStore.addBooking({
				...
				children: 0, // Add appropriate number of children
				mealPlan: 'none', // Add appropriate meal plan
				name: '', // Add appropriate name
				email: '', // Add appropriate email
				flightIncluded: false, // Add appropriate flight inclusion
				cancellationProtection: false, // Add appropriate cancellation protection
				totalCost: 0, // Calculate total cost
			});
...
watch([() => props.startDate, () => props.endDate], () => {
	// Re-filter hotels when the selected dates change
